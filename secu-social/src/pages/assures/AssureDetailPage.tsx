    ...
    <Box>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Typography variant="h4" sx={{ fontWeight: 700, color: '#8B4513' }}>Détails de l'assuré</Typography>
        </Box>
        <Button variant="contained" color="primary" startIcon={<EditIcon />} onClick={() => navigate(`/assures/${id}/edit`)}>Modifier</Button>
      </Box>
